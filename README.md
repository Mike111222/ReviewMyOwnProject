...
**[Review My Project]** is the first milestone to get new Micronauts onboard with the process of code reviews.
...
```sh
  cd my-folder
  git clone git@github.com:Mike111222/ReviewMyOwnProject.git
  ```
